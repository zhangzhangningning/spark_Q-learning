...
workload1 = [
    ...
    "SELECT * FROM lineitem WHERE l_orderkey < 1001",
    "SELECT * FROM lineitem WHERE l_orderkey > 10001 AND l_orderkey < 600000",
    "SELECT * FROM lineitem WHERE l_orderkey < 1001 AND l_quantity > 20",
    "SELECT * FROM lineitem WHERE l_orderkey > 10001 AND l_orderkey < 900000 AND l_quantity > 20",
    "SELECT * FROM lineitem WHERE l_shipdate BETWEEN '1994-01-01' AND '1994-01-31'",
    "SELECT * FROM lineitem WHERE l_shipdate BETWEEN '1994-01-01' AND '1994-01-31' AND l_discount < 0.05 AND l_orderkey < 600000",
